...
namespace ZeroTrustMigrationAddin.Views
{
    public partial class EulaWindow : Window
    {
        ...
        {
            // Official Microsoft Cloud Native Assessment EULA
            EulaTextBlock.Text = @"MICROSOFT SOFTWARE LICENSE TERMS
MICROSOFT CLOUD NATIVE ASSESSMENT
...
EFFET JURIDIQUE. Le présent contrat décrit certains droits juridiques. Vous pourriez avoir d'autres droits prévus par les lois de votre pays. Le présent contrat ne modifie pas les droits que vous confèrent les lois de votre pays si celles-ci ne le permettent pas.";
        ...
        private void AcceptButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            Services.FileLogger.Instance.Info("[EULA] User accepted EULA");
        ...
        private void DeclineButton_Click(object sender, RoutedEventArgs e)
        {
            var result = MessageBox.Show(
                "If you decline the license agreement, the application will close.\n\nAre you sure you want to decline?",
            ...
            {
                Services.FileLogger.Instance.Info("[EULA] User declined EULA");

                // Track declined
                Services.AzureTelemetryService.Instance.TrackEvent("EulaDeclined");
