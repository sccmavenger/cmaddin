...
$Shortcut.Arguments = ""
$Shortcut.Description = "Cloud Journey Dashboard - All Tabs Visible"
...
$Shortcut.Description = "Cloud Journey Dashboard - Workloads & Planning"
$Shortcut.IconLocation = "$exePath,0"
$Shortcut.Save()
...
$Shortcut.Description = "Cloud Journey Dashboard - Technical View"
$Shortcut.IconLocation = "$exePath,0"
$Shortcut.Save()
